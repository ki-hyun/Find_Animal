...
//		out.println(addr);
		...
		out.println("<form class='form-horizontal' role='form' action='../board/Badd' method='post'>");
		...
		out.println("<div class='col-sm-10'>");
		out.println("<input type='text' class='form-control' id='findPlace' name='findPlace'");
		...
		out.println("<div class='col-sm-10'>");
		out.println("<input type='text' class='form-control' id='findDate' name='findDate'");
		...
		out.println("<option>페르시안고양이</option>");
		out.println("<option>브리티시 숏헤어</option>");
		out.println("<option>러시안 블루</option>");
		out.println("<option>노르웨이 숲</option>");
		out.println("<option>터키쉬 앙골라</option>");
		out.println("<option>샴 고양이</option>");
		out.println("<option>스코티시 폴드</option>");
		out.println("<option>셀커크렉스</option>");
		out.println("<option>뱅갈 고양이</option>");
		out.println("<option>아메리칸 숏헤어</option>");
		out.println("<option>아비시니안</option>");
		out.println("<option>먼치킨</option>");
		out.println("<option>사바나캣</option>");
		out.println("<option>메인쿤</option>");
		out.println("<option>코리안 숏헤어(korean shorthair)</option>");
		...
		out.println("<div class='col-sm-10'>");
		out.println("<input type='text' class='form-control' id='photo' name='photo' value='사진'>");
		out.println("</div>");
		out.println("</div>");
		...
		out.println("<div class='form-group'>");
		out.println("<label for='addr' class='col-sm-2 control-label'>아이디</label>");
		out.println("<div class='col-sm-10'>");
		out.println("<input type='text' class='form-control' id='id' name='id'") ;
